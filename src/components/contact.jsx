  ...
  return (
    <section className="bg-gradient-to-t relative from-black-100 form-30% via-black to-black-100 pt-12 pb-10 md:pb-24 lg:py-20 ">
      <div className="container ">
        <div className=" relative  contact-wrap">
          <div className="relative z-10 p-4 bg-black-50 mx-auto rounded-3xl md:rounded-tl-[56px] xl:rounded-tl-[171px]">
            <Image
              src={circle1}
              alt="circle"
              className="absolute bottom-0 opacity-25 hidden md:block"
            />
            <Image
              src={circle2}
              alt="circle"
              className="absolute right-0 opacity-25 hidden md:block"
            />
            <div className="bg-gradient-to-r from-blues-100 to-blues-200 rounded-full h-16 w-16 p-3 xl:h-24 xl:w-24 flex items-center justify-center absolute right-0 -top-4 xl:-right-5 xl:-top-8">
              ...
              <form className="mt-10 lg:mt-24 flex flex-col lg:flex-row gap-8 relative z-20 sm:max-w-[70%] mx-auto">
                <div className="relative flex items-center w-full">
                  <input
                    ...
                    className="py-4 xl:py-8 pl-14 xl:pl-20 flex-none rounded-xl w-full text-slate-400 outline-none z-50"
                  />
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 xl:pl-10">
                    <Email className="w-full z-50" />
                  </div>
                </div>
                <button className="py-4 px-8 xl:py-7 xl:px-12 text-xl xl:text-3xl bg-gradient-to-br from-blues-100 to-blues-200 rounded-xl">
                  Subscribe
                </button>
              </form>
            </div>
